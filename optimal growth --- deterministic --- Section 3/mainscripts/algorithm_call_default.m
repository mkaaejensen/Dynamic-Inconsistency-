function [opts] = algorithm_call_default(a, b, n, MaxIt, innerstep, opts, RESTART, dissaving, dis, p, u, tol, f, offset,dsp)
% CMA-ES algorithm with policy iteration, using z = [x1, D1, ..., Dn].
% x is monotonic in [a,b] via transformCandidate (no ex-post clamping).
%
...
x_old = interp1(linspace(a, b, length(opts)), opts, G, 'linear');
