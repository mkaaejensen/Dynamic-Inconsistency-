...
delete(F);
%addpath(fullfile(pwd, 'figurescripts')); figures embedded in this script
...
loadoutput  = 0;                    % 0: initiates from horizontal policy; 1: load opts from output.mat with handle specified next
    Handle = 'optimal_growth0_90';  % Appended to save and load filenames (saves
...
beta         = 0.90;                % Quasi-hyperbolic discount factor
...
gridprec    = 40;                   % Grid intervals per unit of assets
