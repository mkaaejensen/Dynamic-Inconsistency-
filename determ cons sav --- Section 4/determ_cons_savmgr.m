...
Handle = 'deter_cons_savmgr';  % Appended to save and load (can be left empty/%'ed out leading to repeated overwrite)
...
algorithm   = 'ssr';
                        ...
                        % 'tsa'         %   Hybrid CMA-ES-policy iteration
                                        ...
                                        %   consistent models)
dissaving = 2;        % if = 1, second-mover is limited to weak dissaving policies in Lossfunction (improves speed and accuracy), if =2 the same is true and extra numerical check is made against 45 degree line (very important if steady states are sought, otherwise irrelevant)
