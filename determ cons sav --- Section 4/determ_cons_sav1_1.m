...
Handle = 'deter_cons_save1_1';  % Appended to save and load (can be left empty/%'ed out leading to repeated overwrite)
...
algorithm   = 'ssr';
                            ...
                            % 'tsa'         %   Hybrid CMA-ES-policy iteration algorithm
...
% Define offset function for consumption-saving model
